...
##### Separating the data
```{r}
#df <- read.csv(iris, header = FALSE,col.names =names)
df <- iris
...
show_outerData <- function(){
  ...
  cat("\n Setosa-Versicolor: ")
  print(outer(as.matrix(setosa_Data[,-5]),as.matrix(Versicolor_Data[,-5])))
  cat("\n Setosa-Virginica: ")
  print(outer(as.matrix(setosa_Data[,-5]),as.matrix(Virginica_Data[,-5])))
  cat("\n Versicolor-Virginica: ")
  print(outer(as.matrix(Versicolor_Data[,-5]),as.matrix(Virginica_Data[,-5])))
  cat("\n Versicolor-Setosa: ")
  print(outer(as.matrix(Versicolor_Data[,-5]),as.matrix(setosa_Data[,-5])))
  cat("\n Virginica-Setosa: ")
  print(outer(as.matrix(Virginica_Data[,-5]),as.matrix(setosa_Data[,-5])))
  cat("\n Virginica-Versicolor: ")
  print(outer(as.matrix(Virginica_Data[,-5]),as.matrix(Versicolor_Data[,-5])))
}
